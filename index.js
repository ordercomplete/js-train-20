...
myTruck.tow(9500); // Тягнення навантаження...

// Викликаємо метод tow з вагою більшою за towingCapacity
myTruck.tow(10500); // Навантаження занадто важке для буксирування.
...
let driveMyCar = Car.prototype.drive.bind(car);
driveMyCar(100);
